...
interface AuthContextType {
  ...
  loading: boolean;
  signUp: (email: string, password: string, fullName: string, mobileNumber: string, address?: string) => Promise<{ error: AuthError | null }>;
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signUp = async (email: string, password: string, fullName: string, mobileNumber: string, address?: string) => {
    try {
